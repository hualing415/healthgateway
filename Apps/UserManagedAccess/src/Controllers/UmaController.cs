...
//-------------------------------------------------------------------------
namespace HealthGateway.UserManagedAccess.Controllers
{
    ...
    using HealthGateway.UserManagedAccess.Services;
    ...
    public class UmaController : ControllerBase
    {
        ...
        /// </summary>
        private readonly IUmaService service;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UmaController"/> class.
        /// </summary>
